...
{
    [System.Serializable]
    public class LString : IBaseObejct<string>
    {
        public string Key = "";
        public string Value = "";
    ...
    public class T_LString : LString, IBaseObejct<string>, IDisposable
    {
        public static Container<T_LString, string> MAP = new Container<T_LString, string>();
        public static T_LString Get(string _key)
        {
