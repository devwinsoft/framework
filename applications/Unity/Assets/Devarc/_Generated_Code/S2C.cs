...
namespace Devarc
{
	...
	public class Notify_Player : IBaseObejct
	{
		...
		public override string ToString()
		{
		    ...
		    sb.Append(","); sb.Append(" \"data\":"); sb.Append(data != null ? data.ToString() : "{}");
		    sb.Append("}");
		    return sb.ToString();
		}
		public string ToJson()
		{
		    ...
		    StringBuilder sb = new StringBuilder();
		    sb.Append("{"); sb.Append("\"id\":"); sb.Append("\""); sb.Append(id.ToString()); sb.Append("\"");
		    sb.Append(","); sb.Append("\"data\":"); sb.Append(data != null ? data.ToJson() : "{}");
		    sb.Append("}");
		    return sb.ToString();
		}
	...
	public class Notify_Move : IBaseObejct
	{
		...
		{
		    StringBuilder sb = new StringBuilder();
		    sb.Append("{"); sb.Append(" \"look\":"); sb.Append(look != null ? look.ToString() : "{}");
		...
		public string ToJson()
		{
		    if (IsDefault) { return "{}"; }
		    StringBuilder sb = new StringBuilder();
		    sb.Append("{"); sb.Append("\"look\":"); sb.Append(look != null ? look.ToJson() : "{}");
			if (default(DIRECTION) != move) { sb.Append(","); sb.Append("\"move\":"); sb.Append("\""); sb.Append(move.ToString()); sb.Append("\""); }
		    sb.Append("}");
		    return sb.ToString();
		}
		public PropTable ToTable()
	...
	public class Notify_Chat : IBaseObejct
	{
		...
		public string ToJson()
		{
		    if (IsDefault) { return "{}"; }
		    StringBuilder sb = new StringBuilder();
		    sb.Append("{"); sb.Append("\"_msg\":"); sb.Append("\""); sb.Append(FrameworkUtil.JsonString(_msg)); sb.Append("\"");
		    sb.Append("}");
		    return sb.ToString();
		}
		public PropTable ToTable()
